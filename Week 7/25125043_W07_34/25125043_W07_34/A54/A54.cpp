    ...
    while (choice != 0) {
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                int num;
                std::cin >> num;
                if (num < 1 || num > CL.size) {
                    std::cerr << "Invalid course number.\n";
                    break;
                }
                CoOut(CL.q[num - 1], fout);
                fout.close();
                break;
            }
            case 3: {
